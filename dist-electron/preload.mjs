...
electron.contextBridge.exposeInMainWorld("ipcRenderer", {
  ...
  devolverVenta: (id_venta, responsable) => electron.ipcRenderer.invoke("devolver-venta", id_venta, responsable),
  ...
  getVentasHoy: () => electron.ipcRenderer.invoke("get-ventas-hoy"),
